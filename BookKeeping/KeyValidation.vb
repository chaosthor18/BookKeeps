...
Module Module1
    ...
    Public Sub AssignValidation(ByRef CTRL As System.Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        ...
        Select Case Validation_Type
            ...
            Case ValidationType.Integer_Number
                AddHandler txt.KeyPress, AddressOf Integernum_Leave
        End Select
    End Sub
    Public Sub number_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        End If
    End Sub
    Public Sub Integernum_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Dim numbers As System.Windows.Forms.TextBox = sender
        If InStr("1234567890", e.KeyChar) = 0 And Asc(e.KeyChar) <> 8 Or (e.KeyChar = "." And InStr(numbers.Text, ".") > 0) Then
            e.KeyChar = Chr(0)
            e.Handled = True
